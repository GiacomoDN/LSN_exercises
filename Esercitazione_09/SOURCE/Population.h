...
class Population{
    ...
    //arma::field<Individual> _current_generation;        // Popolazione di individui della generazione corrente, da usare per la valutazione e la selezione
    //arma::field<Individual> _previous_generation;       // Popolazione di individui della generazione precedente, da usare per il crossover
