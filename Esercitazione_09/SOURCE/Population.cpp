...
void Population :: initialize_files(const std::string& best_length_filepath, const std::string& best_route_filepath, const std::string& half_length_filepath, int n_cities){
    ofstream coutf;
