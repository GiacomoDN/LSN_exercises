...
private:
  ...
  // De Nardi ------ //
  bool _reverse;        // Flag indicating if the simulation is time-reversed
  bool _instantaneous = false;  // Flag indicating if i want to save instantaneous data: instead of setting 50k one-step blocks, that causes the program to be excessively slow, i save all the data in a single 50k-step block
                                // La definisco false e la modifico solo se voglio effettivamente che stampi i dati instantanei
  // De Nardi ------ //
  ...
  int overflow_count_v;     // Conto gli overflow nella distribuzione di v
  int overflow_count_g;     // Conto gli overflow nella distribuzione di g
  std::ofstream out_epot; // Lo stream dell'energia potenziale diventa una variabile della classe
  // Fine modifiche de nardi //////////////////////////////////////////////////////////////////////////////////////////////////////////7
