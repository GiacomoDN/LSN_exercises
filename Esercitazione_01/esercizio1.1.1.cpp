...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < N; i++) {
        ...
        for (int j = 0; j < L; j++) {
            sum1 += rnd.Rannyu(); // Generate uniform random numbers in [0,1)
        }
    ...
    ofstream out("OUTPUT/risultati_01.1.1.dat");
    ...
    out.close();
    cout << "Data successfully saved in: OUTPUT/risultati_01.1.1.dat" << endl;
